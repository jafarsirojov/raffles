...
func NewRouter(params RouterParams) {
	...
	router.HandleFunc(baseUrl+"/estate/{id:[0-9]+}/removeImage/{imageName}", middleware.ApplyMiddleware(params.Handler.DeleteImage, params.Handler.MwCheckAdminAuthToken)).Methods("POST")
