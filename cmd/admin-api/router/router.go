...
func NewRouter(params RouterParams) {
	...
	router.HandleFunc(baseUrl+"/landing/{id:[0-9]+}/uploadMainLogo/{count:[0-9]+}", middleware.ApplyMiddleware(params.Handler.UploadLendingImages, params.Handler.MwCheckAdminAuthToken)).Methods("POST")
	router.HandleFunc(baseUrl+"/landing/{id:[0-9]+}/uploadMainLogo/{count:[0-9]+}", middleware.ApplyMiddleware(params.Handler.UploadLendingImages, params.Handler.MwCheckAdminAuthToken)).Methods("POST")
